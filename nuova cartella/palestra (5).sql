...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2026 at 10:33 AM
...
(7, 8, 'ABB-69F0883124AAC', '2026-04-28', '2026-05-30', 100.00, 'mensile', 'attivo', '', 0, NULL, NULL, 0);
...
(8, 'attivo', '2026-04-28', '0004-01-31', 'massa', 'principiante'),
(10, 'attivo', '2026-04-29', '0222-02-22', 'massa', 'principiante');
...
(4, 'Yoga', '', 'intermedio', 25, 10, 'attivo');
...
(14, 'dipendente', 2000.00, '2026-04-30');
...
(2, 4, 3, '2026-10-05', '10:00:00', '11:00:00', 'Gruppo', '', 'programmata');
...
(1, 7, 100.00, '2026-04-28', 'contanti', 'completato', NULL, '567');
...
(8, 'Fecha1108', 'h@gmail.com', '$2y$10$V01aENATt.OaPADrfsAX3OO3Z.DI/gh32OxWrnSt7kVjwJgNDJNGi', 'Federico', 'Rennella', '3511995572', 'cliente'),
(10, 'Valerio', 'vale@gmail.com', '$2y$10$mkk2vGdugfZuLeJGpLHcb.zcKLBqDcmNuQeyeknBmsCmgdgoarca6', 'Valerio ', 'Ottani', '3331234567', 'cliente'),
(14, 'istr_69f29293dab0e', 't@fifhd.it', '$2y$10$lH0PEOCu86K.FzGFgEL8KO4bgJLtmchTm1ogf7TSNJ//3cGtVRuvS', '4t4', '42r24', '332345434', 'istruttore');
...
(1, 8, 2, '2026-04-29 11:24:37', 'confermata', 1);
...
--
ALTER TABLE `abbonamento`
  MODIFY `id_abbonamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
