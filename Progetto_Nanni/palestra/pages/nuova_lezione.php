...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $stmt = $pdo->prepare("
            INSERT INTO LEZIONE (id_corso, id_sala, data, ora_inizio, ora_fine, tipo_lezione, note, stato)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        ");
        $stmt->execute([
            $_POST['id_corso'],
        ...
        $successo = "Lezione aggiunta con successo!";
    } catch(Exception $e) {
...
<div class="contenuto">
    ...
    <div class="form-box">
        ...
        <?php endif; ?>
        <?php if($successo): ?>
            <div class="successo"><?= $successo ?> <a href="lezioni.php">Torna alle lezioni</a></div>
        <?php endif; ?>
        ...
        <form method="POST">
            ...
            <div class="riga">
                <div class="campo">
                    ...
                    <select name="id_corso" required>
                        ...
                        <option value="<?= $c['id_corso'] ?>"><?= htmlspecialchars($c['nome']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="campo">
                    ...
                    <select name="id_sala" required>
                        ...
                        <option value="<?= $s['id_sala'] ?>"><?= htmlspecialchars($s['nome']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="riga">
                ...
                <div class="campo">
                    ...
                    <input type="text" name="tipo_lezione" placeholder="es. Gruppo, Individuale...">
                </div>
            </div>
            <div class="riga">
                <div class="campo">
